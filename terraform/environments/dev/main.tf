# =============================================================================
# Dev Environment — minimal resources for development and testing
# =============================================================================
...
terraform {
  ...
  # Uncomment after creating the state bucket (see bootstrap instructions in README)
  # backend "gcs" {
...
module "cloud_run" {
  ...
  services = {
    for k, v in var.cloud_run_services : k => merge(v, {
      ...
      # Dev defaults: minimal resources
      min_instances = lookup(v, "min_instances", 0)
      max_instances = lookup(v, "max_instances", 3)
      cpu           = lookup(v, "cpu", "1")
